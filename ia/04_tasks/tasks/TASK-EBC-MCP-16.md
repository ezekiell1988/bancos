# TASK-EBC-MCP-16 — Revisar implementación MCP — Movimientos BCR HTML
...
Revisar implementación MCP — Movimientos BCR HTML

## Contexto

Auditoría técnica de la plantilla bcr-debit-html-xls-v1 (html) y su parser bcr-debit-html.

## Objetivo

Verificar que la detección, el parser y el flujo de importación de la plantilla Movimientos BCR HTML funcionen de forma consistente, registrando hallazgos sin modificar la implementación.
...
Informe de revisión de bcr-debit-html-xls-v1, con hallazgos, riesgos y acciones recomendadas.
