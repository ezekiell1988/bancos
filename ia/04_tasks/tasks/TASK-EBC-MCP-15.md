# TASK-EBC-MCP-15 — Revisar implementación MCP — Movimientos de cuenta BCR
...
Revisar implementación MCP — Movimientos de cuenta BCR

## Contexto

Auditoría técnica de la plantilla bcr-debit-csv-v1 (csv) y su parser bcr-debit-csv.

## Objetivo

Verificar que la detección, el parser y el flujo de importación de la plantilla Movimientos de cuenta BCR funcionen de forma consistente, registrando hallazgos sin modificar la implementación.
...
Informe de revisión de bcr-debit-csv-v1, con hallazgos, riesgos y acciones recomendadas.
