        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("10000000-0000-0000-0000-000000000010"), "bn-debit-csv-v1", "csv", new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), true, "Movimientos de cuenta BN USD", "bn-debit-csv", null },
                    { new Guid("10000000-0000-0000-0000-000000000011"), "bn-debit-csv-crc-v1", "csv", new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), true, "Movimientos de cuenta BN CRC", "bn-debit-csv-crc", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("40000000-0000-0000-0000-000000000011"), "debit-card", new Guid("30000000-0000-0000-0000-000000000002"), null, "bn-debit-01-usd", new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "USD", "BBAD6EA77F349D1265C4082AA7EBCD93D8F975221BE18D17720FA22027E06BA1", true, null },
                    { new Guid("40000000-0000-0000-0000-000000000012"), "debit-card", new Guid("30000000-0000-0000-0000-000000000001"), null, "bcr-debit-01-crc", new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "A9A76820A1F0CEEA89995562122687A33EC9F971692DC4121E2A8D35CDE6343B", true, null },
                    { new Guid("40000000-0000-0000-0000-000000000013"), "debit-card", new Guid("30000000-0000-0000-0000-000000000003"), null, "bac-debit-01-crc", new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "DAFC04C14315C23B1207A1D2CD70B60839F2821BFE2A245938FAB6F863AA9DB5", true, null },
                    { new Guid("40000000-0000-0000-0000-000000000014"), "debit-card", new Guid("30000000-0000-0000-0000-000000000002"), null, "bn-debit-01-crc", new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "46995612194255ABF847233C41563CAFAA3EE6C77F5CBACF59DDA57F8BA34AAF", true, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("20000000-0000-0000-0000-000000000010"), null, new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), (short)1, new Guid("10000000-0000-0000-0000-000000000010"), false, false, "content-terms", "[\"bn-debit-csv-v1\"]", null, null },
                    { new Guid("20000000-0000-0000-0000-000000000011"), null, new DateTimeOffset(new DateTime(2026, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), (short)1, new Guid("10000000-0000-0000-0000-000000000011"), false, false, "content-terms", "[\"bn-debit-csv-crc-v1\"]", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("40000000-0000-0000-0000-000000000011"), new Guid("10000000-0000-0000-0000-000000000010") },
                    ...
                    { new Guid("40000000-0000-0000-0000-000000000014"), new Guid("10000000-0000-0000-0000-000000000011") },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a0000000-0000-0000-0000-000000000001"), -177724.97m, -177724.97m, new Guid("40000000-0000-0000-0000-000000000001"), new DateTimeOffset(new DateTime(2026, 7, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "Saldo inicial", 1m, "other-charge", null, new Guid("60000000-0000-0000-0000-000000000004"), null, null, "53414c494e4943494f310000000000000000000000000000000000000000001", new DateOnly(2026, 4, 18), null },
                    { new Guid("a0000000-0000-0000-0000-000000000003"), -477326.20m, -477326.20m, new Guid("40000000-0000-0000-0000-000000000003"), new DateTimeOffset(new DateTime(2026, 7, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "Saldo inicial", 1m, "other-charge", null, new Guid("60000000-0000-0000-0000-000000000004"), null, null, "53414c494e4943494f330000000000000000000000000000000000000000003", new DateOnly(2026, 4, 18), null },
                    { new Guid("a0000000-0000-0000-0000-000000000004"), -153.18m, -70156.44m, new Guid("40000000-0000-0000-0000-000000000004"), new DateTimeOffset(new DateTime(2026, 7, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "USD", "Saldo inicial", 458m, "other-charge", null, new Guid("60000000-0000-0000-0000-000000000004"), null, null, "53414c494e4943494f340000000000000000000000000000000000000000004", new DateOnly(2026, 4, 18), null },
                    { new Guid("a0000000-0000-0000-0000-000000000005"), -119014.25m, -119014.25m, new Guid("40000000-0000-0000-0000-000000000005"), new DateTimeOffset(new DateTime(2026, 7, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "Saldo inicial", 1m, "other-charge", null, new Guid("60000000-0000-0000-0000-000000000005"), null, null, "53414c494e4943494f350000000000000000000000000000000000000000005", new DateOnly(2026, 5, 18), null },
                    { new Guid("a0000000-0000-0000-0000-000000000013"), 10551.04m, 10551.04m, new Guid("40000000-0000-0000-0000-000000000013"), new DateTimeOffset(new DateTime(2026, 7, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)), "CRC", "Saldo inicial", 1m, "other-charge", null, new Guid("60000000-0000-0000-0000-000000000001"), null, null, "53414c494e4943494f313300000000000000000000000000000000000000013", new DateOnly(2025, 12, 19), null }
                });
