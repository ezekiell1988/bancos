...
public sealed class AccountAuxiliary : AuditableEntity { public required string Name { get; set; } public string? Iban { get; set; } public string? Bank { get; set; } public string? CurrencyCode { get; set; } public string? CardNumberMasked { get; set; } public Guid AccountId { get; set; } public Guid OwnerId { get; set; } public Account? Account { get; set; } public Owner? Owner { get; set; } }
...
public sealed class ImportProgress { public Guid ImportId { get; set; } public Import? Import { get; set; } public int Attempt { get; set; } public required string Stage { get; set; } public int Current { get; set; } public int Total { get; set; } public int Percent { get; set; } public ImportStatus Status { get; set; } public DateTime UpdatedUtc { get; set; } }
...
public sealed class Transaction : AuditableEntity { public Guid AccountAuxiliaryId { get; set; } public Guid ImportId { get; set; } public Import? Import { get; set; } public DateOnly BookingDate { get; set; } public required string ExternalReference { get; set; } public required string SourceFingerprint { get; set; } public decimal AmountCrc { get; set; } public decimal? OriginalAmount { get; set; } public string OriginalCurrencyCode { get; set; } = "CRC"; public decimal? ExchangeRate { get; set; } public TransactionOperationType OperationType { get; set; } = TransactionOperationType.General; public string DescriptionNormalized { get; set; } = ""; public Guid? CategoryId { get; set; } public Category? Category { get; set; } public ClassificationSource ClassificationSource { get; set; } public ClassificationStatus ClassificationStatus { get; set; } = ClassificationStatus.PendingReview; }
public sealed class CreditFinancing : AuditableEntity { public Guid AccountAuxiliaryId { get; set; } public AccountAuxiliary? AccountAuxiliary { get; set; } public Guid ImportId { get; set; } public Import? Import { get; set; } public DateOnly FinancingDate { get; set; } public required string Concept { get; set; } public required string Installments { get; set; } public decimal InstallmentAmount { get; set; } public decimal InitialBalance { get; set; } public decimal OutstandingBalance { get; set; } public string CurrencyCode { get; set; } = "CRC"; public required string SourceFingerprint { get; set; } }
public sealed class CardStatement : AuditableEntity { public Guid AccountAuxiliaryId { get; set; } public AccountAuxiliary? AccountAuxiliary { get; set; } public Guid ImportId { get; set; } public Import? Import { get; set; } public required string CardNumberMasked { get; set; } public required string CardBrand { get; set; } public required string LoyaltyPlan { get; set; } public DateOnly StatementDate { get; set; } public DateOnly PaymentDueDate { get; set; } public decimal MinimumPaymentCrc { get; set; } public decimal MinimumPaymentUsd { get; set; } public decimal CashPaymentCrc { get; set; } public decimal CashPaymentUsd { get; set; } public required string SourceFingerprint { get; set; } }
