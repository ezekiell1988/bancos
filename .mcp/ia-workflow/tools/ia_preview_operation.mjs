...
export default {
  ...
  inputSchema: { type: "object", properties: { operation: { type: "string", enum: ["create_task", "approve_task", "finish_task", "close_task", "add_progress_entry", "create_issue", "close_issue", "create_decision"] }, arguments: { type: "object" } }, required: ["operation", "arguments"], additionalProperties: false },
